...
***MongoDB Atlas*** es el servicio de base de datos que vamos a utilizar. Se trata de un servicio global y en la nube, para aplicaciones modernas, que implementa MongoDB administrado en servidores como *AWS*, *Azure* o *GCP*. 
